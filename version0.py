# only conversation history storing to directus no users
...
def process_query(user_question: str) -> str:
    ...
    print(f"LLM response: {response}")  # Debug the response to confirm it's a string
    print(f"Response type: {type(response)}")  # Debug the type
